...
const galleryItems = [
  { id: 1, url: '/images/online_class(1).jpeg', type: 'image', category: ' online Class', title: 'Morning Yoga Session' },
   { id: 2, url: '/images/online_class(2).jpeg', type: 'image', category: ' online Class', title: 'Morning Yoga Session' },
   ...
   { id: 5, url: '/images/online_class(1).jpeg', type: 'image', category: ' online Class', title: 'Morning Yoga Session' },
  { id: 6, url: 'https://images.squarespace-cdn.com/content/v1/656753170118141586dfc6c4/70f9ac32-a24a-45c4-b2c1-44a457fc8c0a/web+triabgle+closer+Wendy+Oberg.jpg',   type: 'image', category: 'Class', title: 'Group Training' }, 
